...
<body>
	...
	<div class="container" style="margin-top:20px">
		...
		if(isset($_POST['submit'])){
			...
			$sql = mysqli_query($koneksi, "UPDATE biodata_diri SET nama='$nama', nim='$nim', jurusan='$jurusan', alamat='$alamat', foto='$foto' WHERE id='$id'") or die(mysqli_error($koneksi));

			if($foto){
                move_uploaded_file($tmp_name, "uploads/".$foto);
                $sql = mysqli_query($koneksi, "UPDATE biodata_diri SET nama='$nama', nim='$nim', jurusan='$jurusan', alamat='$alamat', foto='$foto' WHERE id='$id'");
            } else {
                $sql = mysqli_query($koneksi, "UPDATE biodata_diri SET nama='$nama', nim='$nim', jurusan='$jurusan', alamat='$alamat' , foto='$foto' WHERE id='$id'");
            }
