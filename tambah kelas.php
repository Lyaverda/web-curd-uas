	...
	<div class="container" style="margin-top:20px">
		...
		if(isset($_POST['submit'])){
			...
			if(mysqli_num_rows($cek) == 0){
				$sql = mysqli_query($koneksi, "INSERT INTO kelas(kode_kelas, nama_makul, kode_dosen, jam) VALUES('$kode_kelas', '$nama_makul', '$kode_dosen', '$jam')") or die(mysqli_error($koneksi));
