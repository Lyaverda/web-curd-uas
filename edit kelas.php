...
<body>
	...
	<div class="container" style="margin-top:20px">
		...
		if(isset($_POST['submit'])){
			...
			$sql = mysqli_query($koneksi, "UPDATE kelas SET kode_kelas='$kode_kelas', nama_makul='$nama_makul', kode_dosen='$kode_dosen', jam='$jam' WHERE id='$id'") or die(mysqli_error($koneksi));
