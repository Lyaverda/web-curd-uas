...
<body>
	...
	<div class="container" style="margin-top:20px">
		...
		if(isset($_POST['submit'])){
			...
			$cek = mysqli_query($koneksi, "SELECT * FROM biodata_diri WHERE nama='$nama'") or die(mysqli_error($koneksi));
			
			if(mysqli_num_rows($cek) == 0){
				$sql = mysqli_query($koneksi, "INSERT INTO biodata_diri(nama, nim, jurusan, alamat) VALUES('$nama', '$nim', '$jurusan', '$alamat')") or die(mysqli_error($koneksi));
				
				if($sql){
					echo '<script>alert("Berhasil menambahkan data."); document.location="tambah biodata diri.php";</script>';
				}else{
		...
		<form action="tambah biodata diri.php" method="post">
